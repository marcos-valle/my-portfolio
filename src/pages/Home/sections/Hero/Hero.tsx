...
const Hero = () => {
  ...
  return (
    ...
    <section>
      <header className="flex justify-between items-center text-xs px-16 mt-4">
        <img src={Logo} alt="Logo: </marcos.dev>" />
      ...
      <div className='flex flex-col items-center mt-20'>
        <img src={Profile} alt="Foto de perfil" className="h-50 rounded-full" />
        ...
        <p className="text-center mt-4">
          Olá, eu sou o Marcos do Valle, um desenvolvedor apaixonado por criar experiências digitais incríveis. <br />Aqui você encontrará meus projetos, habilidades e muito mais!
        </p>
